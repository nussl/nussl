...
class RunAndEvalUnitTest(unittest.TestCase):
    def test_simple(self):
        ...
        drum_sigs = [
            drums.make_copy_with_audio_data(drums.audio_data * g) for g in gains
        ...
        scores_sim = nussl.run_and_eval_prf(
            repet_sim, repet_kwargs, mixtures, true_sources
        )

        repet = nussl.Repet
        scores_repet = nussl.run_and_eval_prf(
            repet, repet_kwargs, mixtures, true_sources
        )
