...
class NMFMFCCUnitTests(unittest.TestCase):
    ...
    def test_2_sin_waves(self):
        ...
        # Set up NMMF MFCC
        nmf_mfcc = nussl.NMF_MFCC(
            test_audio, num_sources=self.n_src, num_templates=2, num_iterations=15
        )
    ...
    def test_benchmark_nmf_mfcc(self):
        ...
        print(
            f'Reading benchmark files from {metadata["save_time"]}, '
            f'version {metadata["nussl_version"]}, made by {metadata["made_by"]}'
        )
