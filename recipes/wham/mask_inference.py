"""
This recipe trains and evaluates a Chimera model
...
OUTPUT_DIR = os.path.expanduser('~/.nussl/recipes/wham_mi/')
...
config = ml.networks.builders.build_recurrent_mask_inference(
    n_features, 600, 4, True, 0.3, 2, ['sigmoid'], normalization_class='BatchNorm'
)
