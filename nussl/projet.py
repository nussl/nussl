...
class Projet(separation_base.SeparationBase):
    ...
    """
    def __init__(self, input_audio_signal, use_librosa_stft=constants.USE_LIBROSA_STFT, num_sources=None, num_iterations=None, num_panning_directions=None, num_projections=None):
