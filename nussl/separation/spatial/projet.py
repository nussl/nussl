...
class Projet(SeparationBase):
    ...
    def create_panning_delay_set(self, pannings, delays, F, I):
    ...
    def create_k_matrix(self):
        ...
        K = np.abs(K.reshape((F,) + self.projection_set.shape[1:-1] + self.location_set.shape[1:-1])) ** self.alpha
